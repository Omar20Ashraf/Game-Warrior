			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2><?php echo e($recentreviews->title); ?></h2>
						<p><?php echo e($recentreviews->par); ?><?php echo e($recentreviews->par); ?></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" 
						 data-setbg="<?php echo e(url('images/recentreview',$recentreviews->image)); ?>">
						<div class="cata <?php echo e($recentreviews->evalution_color); ?>">
							<?php echo e($recentreviews->evalution); ?>
					...
					<div class="blog-content">
						<h3><?php echo e($recentreviews->title); ?></h3>
						<p class="meta-comment">
							<?php echo e($recentreviews->recentReviewcomment->count()); ?>
					...
					<div class="comment-warp">
						...
						<ul class="comment-list">
							<?php $__currentLoopData = $recentreviews->recentReviewcomment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<div class="comment">
					...
					<div class="comment-form-warp">
						...
						<form action="<?php echo e($recentreviews->id); ?>/comments" method="POST" class="comment-form">
