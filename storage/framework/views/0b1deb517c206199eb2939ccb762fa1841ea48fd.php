			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" 
						 data-setbg="<?php echo e(url('images/game/games',$games->image)); ?>">
					...
					<div class="blog-content">
						...
						<p href="" class="meta-comment">
							<?php echo e($games->gamecomment->count()); ?> comment
						</p>
					...
					<div class="comment-warp">
						...
						<ul class="comment-list">
							<?php $__currentLoopData = $games->gamecomment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<div class="comment">
