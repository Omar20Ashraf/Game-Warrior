			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" 
						 data-setbg="<?php echo e(url('images/blog/games',$games->image)); ?>">
					...
					<div class="blog-content">
						...
						<p href="" class="meta-comment">
							<?php echo e($games->blogGamesComment->count()); ?> comment
						</p>
					...
					<div class="comment-warp">
						...
						<ul class="comment-list">
							<?php $__currentLoopData = $games->blogGamesComment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<div class="comment">
