			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2><?php echo e($products->title); ?></h2>
						<p><?php echo e($products->par); ?><?php echo e($products->par); ?></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" 
						 data-setbg="<?php echo e(url('images/features',$products->image)); ?>">
						<div class="cata <?php echo e($products->button_color); ?>">
							<?php echo e($products->button); ?>
					...
					<div class="blog-content">
						...
						<p href="" class="meta-comment">
							<?php echo e($products->featureComment->count()); ?> comment
						</p>
					...
					<div class="comment-warp">
						...
						<ul class="comment-list">
							<?php $__currentLoopData = $products->featureComment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<div class="comment">
					...
					<div class="comment-form-warp">
						...
						<form action="<?php echo e($products->id); ?>/comments" method="POST" class="comment-form">
