...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
		<?php echo Form::open(['route'=>'recentgame.store','method'=>'Post',
						'files'=>true]); ?>		
			...
			<div class="form-group">
				...
				<?php echo e(Form::text('image_button',null,array('class'=>'form-control'))); ?>
			...
			<div class="form-group">
				...
				<?php echo e(Form::text('image_button_class',null,array('class'=>'form-control'))); ?>
