			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2><?php echo e($recentgames->title); ?></h2>
						<p><?php echo e($recentgames->par); ?><?php echo e($recentgames->par); ?></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" 
						 data-setbg="<?php echo e(url('images/recentgame',$recentgames->image)); ?>">
						<div class="cata <?php echo e($recentgames->button_color); ?>">
							<?php echo e($recentgames->button); ?>
					...
					<div class="blog-content">
						<h3><?php echo e($recentgames->title); ?></h3>
						<p class="meta-comment">
							<?php echo e($recentgames->recentGamecomment->count()); ?>
					...
					<div class="comment-warp">
						...
						<ul class="comment-list">
							<?php $__currentLoopData = $recentgames->recentGamecomment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<div class="comment">
					...
					<div class="comment-form-warp">
						...
						<form action="<?php echo e($recentgames->id); ?>/comments" method="POST" class="comment-form">
