		...
		<?php $__empty_1 = true; $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
			<tr>
				<td><?php echo e($feature->id); ?></td>
				 ...
				 <td><?php echo e($feature->par); ?></td>
				 <td><?php echo e($feature->button); ?></td>
				 <td><?php echo e($feature->button_color); ?></td>	

				 <td>
					<a href="<?php echo e(route('feature.edit',$feature->id)); ?>" class="btn btn-default" style="margin-bottom: 15px;">Edit</a>
					
			        <form action="<?php echo e(route('feature.destroy',$feature->id)); ?>"  
			        	  method="POST">
