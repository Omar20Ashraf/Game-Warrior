			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2>{{$recentreviews->title}}</h2>
						<p>{{$recentreviews->par}}{{$recentreviews->par}}</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" 
						 data-setbg="{{ url('images/recentreview',$recentreviews->image) }}">
						<div class="cata {{$recentreviews->evalution_color}}">
							{{$recentreviews->evalution}}
						</div>
						<div class="rgi-extra">
							<div class="rgi-star">
					...
					<div class="blog-content">
						<h3>{{$recentreviews->title}}</h3>
						<p class="meta-comment">
							{{ $recentreviews->recentReviewcomment->count() }}
							Comments
						</p>
					...
					<div class="comment-warp">
						...
						<ul class="comment-list">
							@foreach($recentreviews->recentReviewcomment as $comment)
								<li>
									<div class="comment">
					...
					<div class="comment-form-warp">
						...
						<form action="{{$recentreviews->id}}/comments" method="POST" class="comment-form">
							{{ csrf_field() }}
