			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2>{{$recentgames->title}}</h2>
						<p>{{$recentgames->par}}{{$recentgames->par}}</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" 
						 data-setbg="{{ url('images/recentgame',$recentgames->image) }}">
						<div class="cata {{$recentgames->button_color}}">
							{{$recentgames->button}}
						</div>
						<div class="rgi-extra">
							<div class="rgi-star">
					...
					<div class="blog-content">
						<h3>{{$recentgames->title}}</h3>
						<p class="meta-comment">
							{{ $recentgames->recentGamecomment->count() }}
							Comments
						</p>
					...
					<div class="comment-warp">
						...
						<ul class="comment-list">
							@foreach($recentgames->recentGamecomment as $comment)
								<li>
									<div class="comment">
					...
					<div class="comment-form-warp">
						...
						<form action="{{$recentgames->id}}/comments" method="POST" class="comment-form">
							{{ csrf_field() }}
