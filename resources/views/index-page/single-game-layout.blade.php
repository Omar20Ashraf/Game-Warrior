			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" 
						 data-setbg="{{ url('images/features',$products->image) }}">
						<div class="cata {{$products->button_color}}">
							{{$products->button}}
						</div>
						<div class="rgi-extra">
							<div class="rgi-star">
					...
					<div class="blog-content">
						...
						<p href="" class="meta-comment">
							{{ $products->featureComment->count() }} comment
						</p>
					...
					<div class="comment-warp">
						...
						<ul class="comment-list">
							@foreach($products->featureComment as $comment)
								<li>
									<div class="comment">
					...
					<div class="comment-form-warp">
						...
						<form action="{{$products->id}}/comments" method="POST" class="comment-form">
							{{ csrf_field() }}
